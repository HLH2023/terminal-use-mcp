# terminal-use-mcp: Skill for AI Agents
...
| `REMOTE_COMMAND_DENIED` | Requested command blocked by remote command policy | Check if the command is necessary and allowed; ask user for override |
