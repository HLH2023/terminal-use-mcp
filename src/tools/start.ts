...
export function registerStartTool(server: McpServer, sm: SessionManager, logger: Logger): void {
  server.registerTool(
    "terminal.start",
    {
      ...
      inputSchema: {
        ...
        rows: z.number().default(30).optional().describe("Terminal rows"),
        ...
        ttlMs: z.number().default(3_600_000).optional().describe("Session TTL in ms"),
