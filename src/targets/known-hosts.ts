 ...
 * 不使用 StrictHostKeyChecking=no。V2-2 阶段尚不建立 SSH 连接，因此
 ...
 *
 * V2-2 不发起 SSH 握手，因此无法拿到“实时 host key”做最终 mismatch 判断；
 * 这里返回 known_hosts 中记录的 fingerprint，供后续 V2-3/V2-4 provider 与
