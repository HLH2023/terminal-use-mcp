 ...
 */
export declare function screenBufferToString(buffer: ScreenBuffer): string;
/**
 ...
 * 与“内容从第 0 行开始”。
 */
export declare function getContentRange(buffer: ScreenBuffer): {
    firstRow: number;
    lastRow: number;
};
/**
 ...
 * 标记为空，光标固定在左上角。
 */
export declare function createEmptyScreenBuffer(sessionId: string, cols: number, rows: number): ScreenBuffer;
/**
 ...
 * 被用于安全决策。
 */
export declare function isFullscreenHeuristic(buffer: ScreenBuffer): boolean;
