...
type CreateSnapshotInput = Omit<TerminalSnapshot, "timestamp" | "observationTrust" | "mode" | "scrollbackLineCount"> & {
    scrollbackLineCount?: number;
};
/**
 * 创建 TerminalSnapshot 的工厂函数
 */
export declare function createSnapshot(partial: CreateSnapshotInput): TerminalSnapshot;
export {};
