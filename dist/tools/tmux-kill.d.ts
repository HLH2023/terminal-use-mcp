...
export declare function registerTmuxKillTool(server: McpServer, runtime: TmuxToolRuntime, logger: Logger, hostsConfig?: ReadonlyMap<string, SshHostProfile>): void;
export {};
