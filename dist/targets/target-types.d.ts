 ...
 */
export declare function isSshAgentAuthRef(value: unknown): value is Extract<SshAuthRef, {
    type: "agent";
}>;
/**
 * 类型守卫：key-file 认证引用。
 ...
 */
export declare function isSshKeyFileAuthRef(value: unknown): value is Extract<SshAuthRef, {
    type: "key-file";
}>;
/** 类型守卫：任一安全 SSH 认证引用。 */
export declare function isSshAuthRef(value: unknown): value is SshAuthRef;
